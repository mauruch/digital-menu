...
<div class="${hasErrors(bean: foodInstance, field: 'price', 'error')} required">
    <label for="price" class="control-label"><g:message code="food.price.label" default="Price"/><span
            class="required-indicator">*</span></label>

    <div>
        <g:field class="form-control" name="price" value="${fieldValue(bean: foodInstance, field: 'price')}"
                 required=""/>
...
<div class="${hasErrors(bean: foodInstance, field: 'category', 'error')} required">
    <label for="category" class="control-label"><g:message code="food.category.label" default="Category"/><span
            class="required-indicator">*</span></label>

    <div>
        <g:select class="form-control" id="category" name="category.id" from="${com.digitalmenu.Category.list()}"
                  optionKey="id" required="" value="${foodInstance?.category?.id}" class="many-to-one"/>
...
<div class="${hasErrors(bean: foodInstance, field: 'description', 'error')} ">
    <label for="description" class="control-label"><g:message code="food.description.label"
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="${hasErrors(bean: foodInstance, field: 'isAvailable', 'error')} ">
            <label for="isAvailable" class="control-label"><g:message code="food.isAvailable.label"
                                                                      default="Is Available"/></label>
    ...
    <div class="col-md-2">
        <div class="${hasErrors(bean: foodInstance, field: 'isGlutenFree', 'error')} ">
            <label for="isGlutenFree" class="control-label"><g:message code="food.isGlutenFree.label"
                                                                       default="Is Gluten Free"/></label>
    ...
    <div class="col-md-2">
        <div class="${hasErrors(bean: foodInstance, field: 'isVegetarian', 'error')} ">
            <label for="isVegetarian" class="control-label"><g:message code="food.isVegetarian.label"
                                                                       default="Is Vegetarian"/></label>
