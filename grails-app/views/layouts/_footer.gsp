<footer class="footer">
	<div class="container">
			...
			<div class="col-lg-2">
				...
				<ul class="unstyled">
					...
					<li>
						...
						<a href="${createLink(uri: '/menu')}">Menu</a>
					</li>
					<li>
			    		<i class="glyphicon glyphicon-cutlery"></i>
						<a href="${createLink(uri: '/food')}">Platos</a>
					</li>
					<li>
			    		<i class="glyphicon glyphicon-eur"></i>
						<a href="${createLink(uri: '/')}">Promociones</a>
					</li>
				</ul>
			</div>
			<div class="col-lg-2">
				<h4>303 Restaurant</h4>
				<ul class="unstyled">
					<li>
		...
		<h4>Institucional</h4>
		<p>Este es un espacio para completar
		</p>
